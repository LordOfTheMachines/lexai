...
2. Kurulumu çalıştır (**yönetici/UAC gerekmez** — kişisel kullanıcıya kurulur). Windows "bilinmeyen yayıncı" derse: **Daha fazla bilgi → Yine de çalıştır**. İlk açılışta TensorRT motoru GPU'na göre bir kez hazırlanır (birkaç dakika).
